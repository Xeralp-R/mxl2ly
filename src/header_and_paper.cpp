...
void Paper::set_even_margins(Length left_margin, Length right_margin,
                             Length top_margin, Length bottom_margin) {
    this->even_margins[0] =
    std::make_unique<Statement<Length>>("el_margin", left_margin);
    this->even_margins[1] =
    std::make_unique<Statement<Length>>("er_margin", right_margin);
    this->even_margins[2] =
    std::make_unique<Statement<Length>>("et_margin", top_margin);
    this->even_margins[3] =
    std::make_unique<Statement<Length>>("eb_margin", bottom_margin);
}

void Paper::set_odd_margins(Length left_margin, Length right_margin,
                            Length top_margin, Length bottom_margin) {
    this->odd_margins[0] =
    std::make_unique<Statement<Length>>("ol_margin", left_margin);
    this->odd_margins[1] =
    std::make_unique<Statement<Length>>("or_margin", right_margin);
    this->odd_margins[2] =
    std::make_unique<Statement<Length>>("ot_margin", top_margin);
    this->odd_margins[3] =
    std::make_unique<Statement<Length>>("ob_margin", bottom_margin);
}
